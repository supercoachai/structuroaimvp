...
export const BUNDLES: Record<Locale, Record<string, unknown>> = {
  nl: {
    ...
    registrerenPage: {
      ...
      planTrialSub: "Je betaalt nu niets.",
      planTrialFootnote:
        "Na je proefperiode €12,99/maand. Opzegbaar wanneer je wilt. We slaan je betaalmethode vast. Zeg op vóór je proefperiode afloopt als je niet door wilt, dan betaal je niks.",
  ...
  en: {
    ...
    registrerenPage: {
      ...
      planTrialSub: "You pay nothing today.",
      planTrialFootnote:
        "After your trial, €12.99/month. Cancel anytime. We save your payment method. Cancel before your trial ends if you do not want to continue, and you pay nothing.",
