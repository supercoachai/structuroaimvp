...
export const BUNDLES: Record<Locale, Record<string, unknown>> = {
  nl: {
    ...
    login: {
      ...
      storyHeadingNeutral: "Welkom terug.",
      ...
      emailFallbackHelp: "Log in met e-mail en wachtwoord.",
      ...
      magicLinkHelp:
        "Alleen als je al een account hebt. We sturen een code naar je inbox. Vul die hier in, blijf op deze pagina.",
      ...
      otpLabel: "Code uit je mail",
      otpPlaceholder: "6 cijfers",
      otpCta: "Inloggen met code",
      otpInvalid: "Die code klopt niet of is verlopen. Vraag een nieuwe aan.",
      otpResend: "Andere e-mail of opnieuw sturen",
      magicLinkNoAccount:
    ...
    registrerenPage: {
      ...
      planTrialHeadline: "Je proeftijd is voorbij",
      planTrialSub:
        "Ga verder met Structuro voor €12,99 per maand. Vandaag te betalen, daarna elke maand. Opzegbaar wanneer je wilt.",
      planTrialFootnote:
      ...
      planCtaTrial: "Verder voor €12,99/maand",
  ...
  en: {
    ...
    login: {
      ...
      storyHeadingNeutral: "Welcome back.",
      ...
      emailFallbackHelp: "Sign in with email and password.",
      ...
      magicLinkHelp:
        "Only if you already have an account. We email you a code. Enter it here and stay on this page.",
      ...
      otpLabel: "Code from your email",
      otpPlaceholder: "6 digits",
      otpCta: "Sign in with code",
      otpInvalid: "That code is wrong or expired. Request a new one.",
      otpResend: "Different email or send again",
      magicLinkNoAccount:
    ...
    registrerenPage: {
      ...
      planTrialSub:
        "Continue with Structuro for €12.99 per month. Charged today, then every month. Cancel anytime.",
      planTrialFootnote:
      ...
      planCtaTrial: "Continue for €12.99/month",
