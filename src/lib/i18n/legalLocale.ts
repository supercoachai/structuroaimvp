 ...
 * NL en EN: privacy v1.4 (Amplitude), terms v1.1.
 */
export const legalLocaleBundles: Record<Locale, { legal: Record<string, string> }> = {
  nl: {
    legal: {
      ...
      privacyUpdated: "Versie 1.4, geldig vanaf 3 september 2026.",
  ...
  en: {
    legal: {
      ...
      privacyUpdated: "Version 1.4, effective from 3 September 2026.",
