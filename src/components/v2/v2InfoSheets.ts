  ...
  dump: {
    ...
    rows: [
      ...
      },
      {
        ...
        icon: "plan",
        title: "Hoe het werkt",
        body: "Houd de microfoon vast en praat, of typ. Geen categorie, geen datum. Later kies je in de dagstart, of je verwijdert het.",
      },
      {
        key: "private",
        icon: "private",
  ...
  todo: {
    ...
    rows: [
      ...
      },
      {
        ...
        body: "Voeg toe, vink af, of zet iets tijdelijk op pauze. Afgevinkte taken blijven even staan en landen onder Voltooid vandaag. Rustende taken maak je weer actief in de lijst eronder. Open een taak om hem in kleine stappen te splitsen, zelf of met een voorstel.",
      },
      {
        key: "private",
        icon: "private",
    ...
    rows: [
      {
        ...
        icon: "meaning",
        title: "Wat dit is",
        body: "Twee korte pagina's: eerst zien wat af is, daarna open taken een bestemming geven. Geen score, geen gevoelsvraag.",
      },
      {
        key: "why",
        icon: "why",
        title: "Waarom dit uitmaakt",
        body: "Open dagen blijven in je hoofd hangen. Dichtzetten helpt de lus te sluiten, zodat je hoofd leger kan rusten. Ook een rustige dag telt.",
      },
      {
        key: "plan",
        icon: "plan",
        title: "Hoe het werkt",
        body: "Afgeronde taken verschijnen als erkenning. Wat nog open is mag morgen, even rusten, of weg. Optioneel zet je nog iets in je dump.",
      },
      {
        key: "private",
        icon: "private",
        title: "Geen druk",
        body: "Terug naar home sluit de dag niet. Alleen Dag afronden doet dat. Niets is mislukt als je stopt of weinig afvinkte.",
      },
    ],
  },
};
