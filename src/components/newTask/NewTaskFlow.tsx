...
function StepTitle({
  ...
  // Zet de cursor terug op het lege veld bij elke mislukte 'verder'-klik
  // (ook als de hint al zichtbaar was).
  useEffect(() => {
    if (hint || focusNonce > 0) ref.current?.focus();
  }, [hint, focusNonce]);
