-- Lifecycle: last_seen_at voor s2_still vangnet (recent app-gebruik).
...
COMMENT ON VIEW public.lifecycle_candidates_v1 IS
  'Lifecycle candidates (geen active). Trialling voor 7d card-trial drip. last_seen_at voor stilte-vangnet.';
