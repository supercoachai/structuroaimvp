-- Top3-validatie: afstemmen op product + client (checkinsDb.sanitizeTop3TaskIdsForDate).
-- Eerdere trigger eiste created_at/postponed_to = dagstart-datum; backlog uit eerdere dagen
-- werd zo onterecht geweigerd bij opslaan dagstart.
-- Nieuwe regel: taak hoort bij user, is open (done=false), en niet "niet vandaag".
