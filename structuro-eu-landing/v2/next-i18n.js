...
(function () {
  ...
  var T = {
    nl: {
      ...
      hero_reassure: "Eerst dagstart zonder account · daarna 7 dagen trial",
      cta_chip_trial: "7 dagen gratis",
      cta_chip_card: "eerst zonder account",
      ...
      price_risk: "7 dagen trial na de dagstart",
      ...
      price_guarantee: "14 dagen geld terug na je eerste betaling",
    ...
    en: {
      ...
      hero_reassure: "Day start first, no account · then 7-day trial",
      cta_chip_trial: "7 days free",
      cta_chip_card: "start without an account",
      ...
      price_risk: "7-day trial after the day start",
      ...
      price_guarantee: "14-day money back after your first payment",
