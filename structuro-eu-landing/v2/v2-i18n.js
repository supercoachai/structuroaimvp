...
(function () {
  ...
  var T = {
    nl: {
      ...
      feat4_p:
        "Geen verplichte setup. Een peeker onderaan je dagstart: Eenmalig instellen. Inzicht naast je energie, nooit sturing.",
      phone_stop: "Stoppen",
      ...
      phone_home_micro1: "Glas pakken",
      phone_home_micro2: "Kraan open",
    ...
    en: {
      ...
      feat4_p:
        "No required setup. A peeker at the bottom of your day start: Set once. Insight next to your energy, never steering.",
      phone_stop: "Stop",
      ...
      phone_home_micro1: "Grab a glass",
      phone_home_micro2: "Open the tap",
      phone_home_focus: "Start focus",
