...
(function () {
  ...
  var T = {
    nl: {
      ...
      gidsen_card2_p: "Te veel opties, te weinig start. Zo wordt de berg weer één klik.",
    ...
    en: {
      ...
      gidsen_card2_p: "Too many options, too little start. Make the mountain one click.",
