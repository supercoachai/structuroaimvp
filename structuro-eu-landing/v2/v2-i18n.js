...
(function () {
  ...
  var T = {
    nl: {
        ...
        cycle: {
          ...
          rows: [
            ...
            },
            {
              icon: "plan",
              title: "Aan of uit",
              body: "Aan = zachtere voorstellen in zware weken. Uit = gewoon je dagstart.",
            },
            {
              icon: "private",
              title: "Jij kiest",
      ...
      feat4_p:
        "Geen verplichte setup. Zet cyclus aan in je dagstart als je patronen wilt zien. Of sla over.",
      phone_stop: "Stoppen",
      ...
      phone_home_micro1: "Open het document",
      phone_home_micro2: "Zet timer klaar",
      ...
      phone_focus_hint: "Kies één duur. Geen perfecte keuze nodig.",
      phone_focus_kort: "Kort, begin hier",
      phone_focus_middel: "Middel",
      phone_focus_lang: "Lang",
      ...
      phone_focus_done_title: "Tijd om<br>te kiezen",
      phone_focus_done_sub: "Ben je klaar, of nog even bezig?",
      phone_focus_done_cta: "Ik ben klaar",
      phone_focus_still: "Nog even bezig",
      cycle_off: "Zonder",
      cycle_on: "Cyclus",
      cycle_label: "DAG 14 · FOLLICULAIR",
      cycle_hint: "Alleen context. Geen druk.",
      cycle_sheet_eyebrow: "JE CYCLUS · DAG 14 VAN 28",
      cycle_sheet_title: "Folliculaire fase",
      cycle_sheet_meaning_title: "Wat dit betekent",
      cycle_sheet_meaning:
        "Energie en focus nemen vaak geleidelijk toe in deze fase.",
      cycle_sheet_plan_title: "Hoe Structuro plant",
      cycle_sheet_plan:
        "Kleinere stappen vandaag. Zwaardere taken later in je cyclus.",
      cycle_sheet_gotit: "Begrepen",
    ...
    en: {
        ...
        cycle: {
          ...
          rows: [
            ...
            },
            {
              icon: "plan",
              title: "On or off",
              body: "On = gentler suggestions in heavier weeks. Off = just your day start.",
            },
            {
              icon: "private",
              title: "Your call",
      ...
      feat4_p:
        "No required setup. Turn cycle on in your day start if you want patterns. Or skip.",
      phone_stop: "Stop",
      ...
      phone_home_micro1: "Open the document",
      phone_home_micro2: "Set a timer",
      phone_home_focus: "Start focus",
      ...
      phone_focus_hint: "Pick one length. No perfect choice needed.",
      phone_focus_kort: "Short, start here",
      phone_focus_middel: "Medium",
      phone_focus_lang: "Long",
      ...
      phone_focus_done_title: "Time to<br>choose",
      phone_focus_done_sub: "Are you done, or still going?",
      phone_focus_done_cta: "I'm done",
      phone_focus_still: "Still going",
      cycle_off: "Without",
      cycle_on: "Cycle",
      cycle_label: "DAY 14 · FOLLICULAR",
      cycle_hint: "Context only. No pressure.",
      cycle_sheet_eyebrow: "YOUR CYCLE · DAY 14 OF 28",
      cycle_sheet_title: "Follicular phase",
      cycle_sheet_meaning_title: "What this means",
      cycle_sheet_meaning:
        "Energy and focus often build gradually in this phase.",
      cycle_sheet_plan_title: "How Structuro plans",
      cycle_sheet_plan:
        "Smaller steps today. Heavier tasks later in your cycle.",
      cycle_sheet_gotit: "Got it",
