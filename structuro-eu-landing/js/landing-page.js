...
const TRANSLATIONS = {
  nl: {
    ...
    nav_login: 'Inloggen', nav_cta: 'Start 3 dagen gratis',
    cta_try: 'Start 3 dagen gratis',
    ...
    hero_cta_start: 'Start 3 dagen gratis',
    hero_recognition: 'Tik aan wat klopt →',
    hero_cta_note: '3 dagen gratis. Geen verplichting.',
    ...
    price_trust_line: '3 dagen gratis · 14 dagen niet goed, geld terug',
  ...
  en: {
    ...
    nav_login: 'Log in', nav_cta: 'Start 3 days free',
    cta_try: 'Start 3 days free',
    ...
    hero_cta_start: 'Start 3 days free',
    hero_recognition: 'Tap what fits →',
    hero_cta_note: '3 days free. No commitment.',
    ...
    price_trust_line: '3-day free trial · 14-day money-back guarantee',
