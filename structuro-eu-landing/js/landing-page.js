...
const TRANSLATIONS = {
  nl: {
    ...
    cyclus_frame_main: 'Structuro past zich aan op wat jij vandaag in huis hebt.',
    cyclus_frame_sub: 'Voor vrouwen: ook op je cyclus.',
  ...
  en: {
    ...
    cyclus_frame_main: 'Structuro adapts to whatever you have in you today.',
    cyclus_frame_sub: 'For women: your cycle too.',
