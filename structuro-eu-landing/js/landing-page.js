...
const TRANSLATIONS = {
  nl: {
    ...
    price_feat3: 'Je dag past zich aan hoe vol je batterij vandaag is', price_feat4: 'Afgestemd op het ADHD-brein, inclusief de vrouwelijke cyclus',
  ...
  en: {
    ...
    price_feat3: 'Your day adapts to how full your battery is today', price_feat4: 'Tuned for the ADHD brain, including the female cycle',
