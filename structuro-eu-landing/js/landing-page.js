...
const TRANSLATIONS = {
  nl: {
    ...
    nav_login: 'Inloggen', nav_cta: 'Start 7 dagen gratis',
    cta_try: 'Start 7 dagen gratis',
    ...
    hero_cta_start: 'Start 7 dagen gratis',
    hero_recognition: 'Tik aan wat klopt →',
    hero_cta_note: '7 dagen gratis. Geen verplichting.',
    ...
    live_demo_energy_title: 'Hoe zit je energie?',
    live_demo_energy_hint: 'Tik wat klopt. Voorstellen volgen meteen.',
    ...
    live_demo_signup: 'Begin jouw eerste dag →',
    live_demo_restart: '↻ Demo opnieuw doorlopen',
    live_demo_cycle_label: 'Cyclus',
    live_demo_cycle_eyebrow: 'Eenmalig instellen',
    live_demo_cycle_hint: 'Je cyclus meenemen?',
    live_demo_cycle_tracker: 'Cyclus meenemen',
    live_demo_cycle_tracker_lede: 'Optioneel. Structuro toont je fase stil naast je energie: inzicht, nooit sturing.',
    live_demo_cycle_more: 'Lees hoe cyclus en ADHD samenkomen →',
    energy_low: 'Laag', energy_normal: 'Genoeg', energy_high: 'Hoog',
    ...
    psych_lede: 'Je krijgt per punt precies het antwoord dat erbij hoort, en niets meer.',
    ...
    vrouwen_eyebrow: 'Cyclus',
    vrouwen_h1: 'Cyclus en ADHD: optionele energie-context',
    vrouwen_lede: 'Sommige weken voelt starten zwaarder. In Structuro kun je optioneel je cyclusfase meenemen als stille context naast je energie. Jij kiest wat past. Geen sturing, geen diagnose.',
    vrouwen_disclaimer: 'Cycli verschillen per persoon. In Structuro stuur jij zelf: geen algoritme.',
    vrouwen_exec_link: 'ADHD bij vrouwen als starten, werk en huis? <a href="/adhd-bij-vrouwen/">Lees de gids</a>. Deze pagina gaat alleen over optionele cycluscontext.',
    ...
    pricing_lede: '7 dagen gratis uitproberen. Daarna €12,99 per maand.',
    ...
    price_trial_badge: '7 dagen gratis',
    price_monthly_label: 'Maandelijks', price_monthly_period: '/ maand',
    price_monthly_sub: '7 dagen gratis · daarna pas betalen',
    price_feat1: 'Geen lijst die groeit terwijl jij stilstaat', price_feat2: 'Een eerste stap klein genoeg om echt te beginnen',
    price_feat3: 'Je dag past zich aan hoe vol je batterij vandaag is', price_feat4: 'Afgestemd op het ADHD-brein, met optionele cycluscontext',
    price_feat5: 'Eindelijk rust in je hoofd. Elke dag opnieuw.',
    price_available: 'Start je eerste dag',
    price_trust_line: '7 dagen gratis · 14 dagen niet goed, geld terug',
    pricing_compare_lead: 'Goedkoper dan wat je vergeten bent op te zeggen:',
    pricing_compare_line1: 'Vergeten sportschool',
    pricing_compare_line2: 'Ongebruikte streaming',
    pricing_compare_line3: 'Apps die je nooit opent',
    pricing_compare_amount1: '€30',
    pricing_compare_amount2: '€13',
    pricing_compare_amount3: '€15',
    pricing_compare_total: 'Totaal vergeten',
    pricing_compare_total_amount: '€58/maand',
    ...
    faq1_a: 'Je proefperiode duurt 7 dagen, gratis. Daarna betaal je pas als je doorgaat. Niet tevreden na je eerste betaling? Mail binnen 14 dagen naar info@structuro.eu met onderwerp \'Geld terug\'. Je hoort binnen één werkdag terug. Het bedrag staat meestal binnen 5 tot 10 werkdagen op je rekening.',
  ...
  en: {
    ...
    nav_login: 'Log in', nav_cta: 'Start 7 days free',
    cta_try: 'Start 7 days free',
    ...
    hero_cta_start: 'Start 7 days free',
    hero_recognition: 'Tap what fits →',
    hero_cta_note: '7 days free. No commitment.',
    ...
    live_demo_energy_hint: 'Tap what fits. Suggestions follow right away.',
    ...
    live_demo_signup: 'Start your first day →',
    live_demo_restart: '↻ Restart the demo',
    live_demo_cycle_label: 'Cycle',
    live_demo_cycle_eyebrow: 'Set once',
    live_demo_cycle_hint: 'Include your cycle?',
    live_demo_cycle_tracker: 'Include cycle',
    live_demo_cycle_tracker_lede: 'Optional. Structuro shows your phase quietly next to energy: insight, never steering.',
    live_demo_cycle_more: 'Read how cycle and ADHD connect →',
    energy_low: 'Low', energy_normal: 'Okay', energy_high: 'High',
    ...
    psych_tag5: 'Cycle', psych_h3_5: 'Energy across the month',
    psych_p5: 'Some weeks starting feels heavier. In Structuro you can optionally include your cycle phase as quiet context next to your energy, without comparing you to yesterday.',
    ...
    vrouwen_eyebrow: 'Cycle',
    vrouwen_h1: 'Cycle and ADHD: optional energy context',
    vrouwen_lede: 'Some weeks starting feels heavier. In Structuro you can optionally include your cycle phase as quiet context next to your energy. You choose what fits. No steering, no diagnosis.',
    vrouwen_disclaimer: 'Cycles differ per person. In Structuro you stay in control: no algorithm.',
    vrouwen_exec_link: 'ADHD in women as starting, work and home? <a href="/adhd-bij-vrouwen/">Read the guide</a> (Dutch). This page is only about optional cycle context.',
    ...
    pricing_lede: '7 days free to try. Then €12.99 per month.',
    ...
    price_trial_badge: '7 days free',
    price_monthly_label: 'Monthly', price_monthly_period: '/ month',
    price_monthly_sub: '7 days free · pay only if you continue',
    price_feat1: 'No list that grows while you stand still', price_feat2: 'A first step small enough to actually start',
    price_feat3: 'Your day adapts to how full your battery is today', price_feat4: 'Tuned for the ADHD brain, with optional cycle context',
    price_feat5: 'Finally quiet in your head. Every day anew.',
    price_available: 'Start your first day',
    price_trust_line: '7-day free trial · 14-day money-back guarantee',
    pricing_compare_lead: 'Cheaper than what you forgot to cancel:',
    pricing_compare_line1: 'Forgotten gym',
    pricing_compare_line2: 'Unused streaming',
    pricing_compare_line3: 'Apps you never open',
    pricing_compare_amount1: '€30',
    pricing_compare_amount2: '€13',
    pricing_compare_amount3: '€15',
    pricing_compare_total: 'Total forgotten',
    pricing_compare_total_amount: '€58/month',
    ...
    faq1_a: 'Your trial lasts 7 days, free. You only pay if you continue after that. Not satisfied after your first payment? Email info@structuro.eu within 14 days with subject \'Refund\'. You hear back within one business day. The amount usually returns within 5 to 10 business days.',
